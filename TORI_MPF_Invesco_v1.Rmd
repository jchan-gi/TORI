...
年率化回報 Annualized Return: ~9.05%     
算術年均回報 Mean Annual Return: ~9.12%       
累積回報（等比） Cumulative Return (Geometric): ~418.94%    
年率化標準誤差 Annualized Standard Deviation: ~9.28% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 9.05%/9.28% = 0.9757          
索丁諾比率 Sortino Ratio: 0.5580 (MAR = 0%)      
預期損失 Expected Shortfall: 5.01 % loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 961789.3        
算術年均回報 Mean annual return: 8.72%      
內部回報率 Internal Rate of Return (IRR): 9.39%    
年率化標準誤差 Annualized Standard Deviation: 9.27%    
夏普比率 Sharpe Ratio: 0.9412          
索丁諾比率 Sortino Ratio: 0.5628 (MAR = 0%)    
...
rm(MPF.Invesco.AE, MPF.Invesco.B, MPF.Invesco.BG, MPF.Invesco.CA, MPF.Invesco.G,
                               MPF.Invesco.GB, MPF.Invesco.GE, MPF.Invesco.HKE, MPF.Invesco.MPFC, MPF.Invesco.RMBB,
                               MPF.Invesco.S, MPF.Invesco.SFP)
```
...
total.contribution <- 1500 * length(MPF.Invesco.returns[, 1])
