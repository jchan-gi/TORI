...
算術年均回報 Mean Annual Return: ~9.56%       
累積回報（等比） Cumulative Return (Geometric): ~390.10%    
年率化標準誤差 Annualized Standard Deviation: ~9.88% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 0.9675          
索丁諾比率 Sortino Ratio: 1.9670 (MAR = 0%)      
預期損失 Expected Shortfall: 5.38% loss (0% Risk-free rate, 95% C.I.)       
