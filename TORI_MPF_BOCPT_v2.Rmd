...
年率化回報 Annualized Return: ~9.47%     
算術年均回報 Mean Annual Return: ~9.57%       
累積回報 Cumulative Return: ~458.39%    
年率化標準誤差 Annualized Standard Deviation: ~9.94% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 0.9533         
索丁諾比率 Sortino Ratio: 1.9464 (MAR = 0%)    
資訊比率 Information Ratio: 0.1849 (SPY), 0.3545 (HSI), 0.2143 (Golden Butterfly)    
Jensen's Alpha: 0.0756 (SPY), 0.0838 (HSI), 0.1065 (Golden Butterfly)    
Beta: 0.2901 (SPY), 0.2708 (HSI), 0.0484 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.4196 (SPY), 0.5551 (HSI), 0.0332 (Golden Butterfly)    
預期損失 Expected Shortfall: 2.74% loss (0% Risk-free rate, 95% C.I.)      
