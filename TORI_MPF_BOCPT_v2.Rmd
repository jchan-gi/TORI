...
最新結餘 Latest asset value: 1504018        
算術年均回報 Mean annual return: 7.62%      
內部回報率 Internal Rate of Return (IRR): 9.32%    
年率化標準誤差 Annualized Standard Deviation: 9.66%    
夏普比率 Sharpe Ratio: 0.7886          
索丁諾比率 Sortino Ratio: 1.9737 (MAR = 0%)    
...
kable(df, "pandoc",
      col.names = c("指標 Indicator", "Tori @ BOCPT", "SPY", "HSI", "Golden Butterfly"))
```
