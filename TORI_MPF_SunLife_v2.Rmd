...
年率化回報 Annualized Return: ~9.99%     
算術年均回報 Mean Annual Return: ~9.59%       
累積回報 Cumulative Return: ~468.56%    
年率化標準誤差 Annualized Standard Deviation: ~8.87% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.1197          
索丁諾比率 Sortino Ratio: 2.9177 (MAR = 0%)      
預期損失 Expected Shortfall: 3.91 % loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1380085        
算術年均回報 Mean annual return: 10.01%      
內部回報率 Internal Rate of Return (IRR): 9.54%    
年率化標準誤差 Annualized Standard Deviation: 8.87%    
夏普比率 Sharpe Ratio: 1.1295          
索丁諾比率 Sortino Ratio: 2.9553 (MAR = 0%)    
