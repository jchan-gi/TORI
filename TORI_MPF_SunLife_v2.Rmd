...
年率化回報 Annualized Return: ~10.14%     
算術年均回報 Mean Annual Return: ~9.73%       
累積回報 Cumulative Return: ~483.41%    
年率化標準誤差 Annualized Standard Deviation: ~8.89%     
夏普比率 Sharpe Ratio: 1.1414          
索丁諾比率 Sortino Ratio: 2.9447 (MAR = 0%)      
資訊比率 Information Ratio: 0.1447 (SPY), 0.2484(HSI), 0.2126 (Golden Butterfly)     
Jensen's Alpha: 0.1015 (SPY), 0.1017 (HSI), 0.1000 (Golden Butterfly)    
Beta: 0.0436 (SPY), 0.0518 (HSI), 0.678 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.0690 (SPY), 0.1165 (HSI), 0.0545 (Golden Butterfly)    
預期損失 Expected Shortfall: 6.84 % loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1413811        
算術年均回報 Mean annual return: 10.15%      
內部回報率 Internal Rate of Return (IRR): 9.75%    
年率化標準誤差 Annualized Standard Deviation: 8.88%    
夏普比率 Sharpe Ratio: 1.1431          
索丁諾比率 Sortino Ratio: 2.9821 (MAR = 0%)    
