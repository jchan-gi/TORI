...
kable(df, "pandoc",
      col.names = c("指標 Indicator", "Tori @ SunLife Rainbow", "SPY", "HSI", "Golden Butterfly"))
```
...
MPF.SunLife <-
  as.xts(
    read.zoo(
      paste(Sys.getenv("onedrive"),"//MPF/Sun Life Rainbow/SunLife.csv",sep=""),
      format = "%d/%m/%Y",
      header = TRUE,
      read = read.csv,
      na.strings = "0"
...
kable(df, "pandoc",
      col.names = c("指標 Indicator", "Tori @ SunLife", "SPY", "HSI", "Golden Butterfly"))
```
