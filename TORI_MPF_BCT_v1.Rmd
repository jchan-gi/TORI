...
年率化回報 Annualized Return: ~9.85%     
算術年均回報 Mean Annual Return: ~9.61%       
累積回報（等比） Cumulative Return (Geometric): ~500.18%    
年率化標準誤差 Annualized Standard Deviation: ~8.13% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 9.85%/8.13% = 1.211          
索丁諾比率 Sortino Ratio: 0.7695 (MAR = 0%)      
預期損失 Expected Shortfall: 3.92% loss (0% Risk-free rate, 95% C.I.)       
