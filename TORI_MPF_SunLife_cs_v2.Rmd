...
年率化回報 Annualized Return: ~11.24%     
算術年均回報 Mean Annual Return: ~10.73%       
累積回報 Cumulative Return: ~598.84%    
年率化標準誤差 Annualized Standard Deviation: ~8.92% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.2600          
索丁諾比率 Sortino Ratio: 3.2669 (MAR = 0%)      
資訊比率 Information Ratio: 0.2112 (SPY), 0.3003(HSI), 0.3001 (Golden Butterfly)     
Jensen's Alpha: 0.1126 (SPY), 0.1127 (HSI), 0.1099 (Golden Butterfly)    
Beta: 0.0425 (SPY), 0.0511 (HSI), 0.0680 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.0670 (SPY), 0.1145 (HSI), 0.0546 (Golden Butterfly)    
預期損失 Expected Shortfall: 6.37% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1421524        
算術年均回報 Mean annual return: 10.24%      
內部回報率 Internal Rate of Return (IRR): 9.79%    
年率化標準誤差 Annualized Standard Deviation: 8.91%    
夏普比率 Sharpe Ratio: 1.1492          
索丁諾比率 Sortino Ratio: 2.9695 (MAR = 0%)    
...
ggplot() +
  ...
  geom_line(aes(x = date, y = Ra, color = "pink3"), portf.dollar.monthly, size =
              1.8) +
  labs(
    title = "TORI @ SunLife (civil servant pricing) versus SPY, QQQ, and Hang Seng Index",
    subtitle = "How TORI @ SunLife outperform common index fund",
    x = "",
    y = "Portfolio Value",
...
ggplot() +
  ...
  geom_line(aes(x = date, y = Ra, color = "pink3"),
            ...
            size = 1.8) +
  labs(
    title = "TORI @ SunLife (civil servant pricing) versus Golden Butterfly Portfolio",
    subtitle = "How TORI @ SunLife outperform golden butterfly portfolio",
    x = "",
    y = "Portfolio Value",
    color = "Portfolio"
  ) +
