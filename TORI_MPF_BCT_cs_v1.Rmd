...
年率化回報 Annualized Return: ~10.66%     
算術年均回報 Mean Annual Return: ~10.36%       
累積回報（等比） Cumulative Return (Geometric): ~591.12%    
年率化標準誤差 Annualized Standard Deviation: ~8.14% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 10.66%/8.14% = 1.3098          
索丁諾比率 Sortino Ratio: 0.8453 (MAR = 0%)      
預期損失 Expected Shortfall: 3.85% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 943591.2        
算術年均回報 Mean annual return: 9.34%      
內部回報率 Internal Rate of Return (IRR): 9.15%    
年率化標準誤差 Annualized Standard Deviation: 8.38%    
夏普比率 Sharpe Ratio: 1.1143          
索丁諾比率 Sortino Ratio: 0.7824 (MAR = 0%)    
