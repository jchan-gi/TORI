...
年率化回報 Annualized Return: ~11.68%     
算術年均回報 Mean Annual Return: ~11.46%       
累積回報 Cumulative Return: ~715.73%    
年率化標準誤差 Annualized Standard Deviation: ~8.68% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.3204          
索丁諾比率 Sortino Ratio: 3.2925 (MAR = 0%)      
預期損失 Expected Shortfall: 3.69% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1450243        
算術年均回報 Mean annual return: 10.40%      
內部回報率 Internal Rate of Return (IRR): 9.24%    
年率化標準誤差 Annualized Standard Deviation: 9.07%    
夏普比率 Sharpe Ratio: 1.1466          
索丁諾比率 Sortino Ratio: 3.0569 (MAR = 0%)    
