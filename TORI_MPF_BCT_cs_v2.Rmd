...
資訊比率 Information Ratio: 0.3998 (SPY), 0.517 (HSI)    
Jensen's Alpha: 0.1014 (SPY), 0.1107 (HSI)    
Beta: 0.2897 (SPY), 0.2572 (HSI)     
關聯系數 Correlation Coefficient: 0.4544 (SPY), 0.5717 (HSI)    
...
ggplot()+
  ...
  labs(title = "TORI @ BCT(Civil Servant) versus SPY, QQQ, and Hang Seng Index",
