...
算術年均回報 Mean Annual Return: ~11.95%       
累積回報 Cumulative Return: ~788.39%    
年率化標準誤差 Annualized Standard Deviation: ~9.17% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.3292          
索丁諾比率 Sortino Ratio: 3.4038 (MAR = 0%)    
資訊比率 Information Ratio: 0.3998 (SPY), 0.517 (HSI), 0.4366 (Golden Butterfly)    
Jensen's Alpha: 0.1014 (SPY), 0.1107 (HSI), 0.1375 (Golden Butterfly)    
Beta: 0.2897 (SPY), 0.2572 (HSI), -0.120 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.4544 (SPY), 0.5717 (HSI), -0.0089 (Golden Butterfly)    
預期損失 Expected Shortfall: 3.37% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1882912        
算術年均回報 Mean annual return: 10.58%      
內部回報率 Internal Rate of Return (IRR): 11.33%    
年率化標準誤差 Annualized Standard Deviation: 9.15%    
夏普比率 Sharpe Ratio: 1.1570          
索丁諾比率 Sortino Ratio: 3.0759 (MAR = 0%)    
...
for (row in 1:length(MPF.BCT.BIAS.month[, 1])) {
  ...
  portf.rebal.fm <-
    Return.portfolio(
      na.fill(MPF.BCT.simple.returns, 0),
...
ggplot()+
  ...
  labs(title = "TORI @ BCT (civil servant pricing) versus SPY, QQQ, and Hang Seng Index",
...
ggplot()+
  ...
  labs(title = "TORI @ BCT (civil servant pricing) versus Golden Butterfly Portfolio",
