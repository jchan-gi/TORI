...
年率化回報 Annualized Return: ~10.73%     
算術年均回報 Mean Annual Return: ~10.60%       
累積回報 Cumulative Return: ~593.02%    
年率化標準誤差 Annualized Standard Deviation: ~8.69% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.2198          
索丁諾比率 Sortino Ratio: 2.9663 (MAR = 0%)      
預期損失 Expected Shortfall: 3.75% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1444275        
算術年均回報 Mean annual return: 10.29%      
內部回報率 Internal Rate of Return (IRR): 9.21%    
年率化標準誤差 Annualized Standard Deviation: 9.09%    
夏普比率 Sharpe Ratio: 1.1321          
索丁諾比率 Sortino Ratio: 3.0103 (MAR = 0%)    
