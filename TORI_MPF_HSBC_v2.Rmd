...
df <- data.frame(c("年率化回報 Annualized Return", "累積回報 Cumulative Return",
                 ...
                 c("11.55%", "720.61%", "10.56%", "1.0944", "2.4896", "-->",
                    "-->", "-->", "-->", "2.92% loss"),
                 c("5.36%", "/", "14.99%", "0.3577", "/", "0.1447", "0.1015", "0.0436",
                    "0.0690", "/"),
                 c("2.21%", "/", "20.53%", "0.1078", "/", "0.2484", "0.1017", "0.0518",
                    "0.1165", "/"),
                 c("7.24%", "/", "7.43%", "0.9748", "/", "0.2126",
                    "0.1000", "0.678", "0.0545", "/")
                 )
...
年率化回報 Annualized Return: ~12.85%     
算術年均回報 Mean Annual Return: ~12.73%       
累積回報 Cumulative Return: ~893.51%    
年率化標準誤差 Annualized Standard Deviation: ~10.96% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.1715          
索丁諾比率 Sortino Ratio: 2.5482 (MAR = 0%)      
資訊比率 Information Ratio: 0.4237 (SPY), 0.5570(HSI), 0.4135 (Golden Butterfly)     
Jensen's Alpha: 0.1063 (SPY), 0.1165 (HSI), 0.1414 (Golden Butterfly)    
Beta: 0.3312 (SPY), 0.0319 (HSI), -0.0242 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.4342 (SPY), 0.5608 (HSI), -0.0159 (Golden Butterfly)    
預期損失 Expected Shortfall: 2.92% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 2384496    
算術年均回報 Mean annual return (arithmetric): 12.48%      
內部回報率 Internal Rate of Return (IRR): 13.15%    
年率化標準誤差 Annualized Standard Deviation: 11.14%    
夏普比率 Sharpe Ratio: 1.1201          
索丁諾比率 Sortino Ratio: 2.5291 (MAR = 0%)    
