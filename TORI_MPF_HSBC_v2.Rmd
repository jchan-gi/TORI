...
年率化回報 Annualized Return: ~12.63%     
算術年均回報 Mean Annual Return: ~12.53%       
累積回報 Cumulative Return: ~858.42%    
年率化標準誤差 Annualized Standard Deviation: ~10.95% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.1443          
索丁諾比率 Sortino Ratio: 2.5163 (MAR = 0%)      
預期損失 Expected Shortfall: 5.53% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 2311070    
算術年均回報 Mean annual return (arithmetric): 12.30%      
內部回報率 Internal Rate of Return (IRR): 12.91%    
年率化標準誤差 Annualized Standard Deviation: 11.13%    
夏普比率 Sharpe Ratio: 1.1049          
索丁諾比率 Sortino Ratio: 2.4978 (MAR = 0%)    
...
MPF.HSBC.returns <- merge(MPF.HSBC.AP, MPF.HSBC.B, MPF.HSBC.CA, MPF.HSBC.CE, 
...
colnames(MPF.HSBC.returns) <- c("AP", "B", "CA", "CE", 
                                "EE", "GB", "G", "HSIT", 
                                "HKCE", "MPFC", "NA", "S", 
                                "HSHIT", "VCAP", "VCB", "VCE", 
                                "VCUS", "GE")
...
MPF.HSBC.simple.returns <- merge(MPF.HSBC.AP, MPF.HSBC.B, MPF.HSBC.CA, MPF.HSBC.CE, 
                          MPF.HSBC.EE, MPF.HSBC.GB, MPF.HSBC.G, MPF.HSBC.HSIT, 
                          MPF.HSBC.HKCE, MPF.HSBC.MPFC, MPF.HSBC.NA, MPF.HSBC.S, 
                          MPF.HSBC.HSHIT, MPF.HSBC.VCAP, MPF.HSBC.VCB, MPF.HSBC.VCE, 
                          MPF.HSBC.VCUS, MPF.HSBC.GE)
...
colnames(MPF.HSBC.simple.returns) <- c("AP", "B", "CA", "CE", 
                                "EE", "GB", "G", "HSIT", 
                                "HKCE", "MPFC", "NA", "S", 
                                "HSHIT", "VCAP", "VCB", "VCE", 
                                "VCUS", "GE")
...
total.contribution <- 2301 * length(MPF.HSBC.simple.returns[, 1])
