...
年率化回報 Annualized Return: ~9.25%     
算術年均回報 Mean Annual Return: ~9.30%       
累積回報（等比） Cumulative Return (Geometric): ~437.10%    
年率化標準誤差 Annualized Standard Deviation: ~9.28%    
夏普比率 Sharpe Ratio: 0.9964          
索丁諾比率 Sortino Ratio: 2.1562 (MAR = 0%)      
資訊比率 Information Ratio: 0.1674 (SPY), 0.3440 (HSI), 0.1572 (Golden Butterfly)    
Jensen's Alpha: 0.0757 (SPY), 0.0815 (HSI), 0.1048 (Golden Butterfly)    
Beta: 0.2541 (SPY), 0.2611 (HSI), -0.0466 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.3934 (SPY), 0.5728 (HSI), -0.0366 (Golden Butterfly)    
預期損失 Expected Shortfall: 2.01 % loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1509887        
算術年均回報 Mean annual return: 8.85%      
內部回報率 Internal Rate of Return (IRR): 9.58%    
年率化標準誤差 Annualized Standard Deviation: 9.26%    
夏普比率 Sharpe Ratio: 0.9552          
索丁諾比率 Sortino Ratio: 2.1559 (MAR = 0%)    
...
MPF.Fidelity.SFP <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/SFP.xlsx")
MPF.Fidelity.SFP[, 1] <- convertToDate(MPF.Fidelity.SFP[, 1])
MPF.Fidelity.SFP <-
  MPF.Fidelity.SFP[11:length(MPF.Fidelity.SFP[, 1]), ]
rownames(MPF.Fidelity.SFP) <- MPF.Fidelity.SFP[, 1]
colnames(MPF.Fidelity.SFP) <- c("Date", "HKD")
MPF.Fidelity.SFP <-
  as.xts(read.zoo(MPF.Fidelity.SFP, format = "%Y-%m-%d"))

MPF.Fidelity.CA <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/CA.xlsx")
...
MPF.Fidelity.CA <-
  as.xts(read.zoo(MPF.Fidelity.CA, format = "%Y-%m-%d"))

MPF.Fidelity.AP <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/AP.xlsx")
...
MPF.Fidelity.AP <-
  as.xts(read.zoo(MPF.Fidelity.AP, format = "%Y-%m-%d"))

MPF.Fidelity.B <- read.xlsx("F:/OneDrive/MPF/Fidelity/202001/B.xlsx")
...
MPF.Fidelity.B <-
  as.xts(read.zoo(MPF.Fidelity.B, format = "%Y-%m-%d"))

MPF.Fidelity.S <- read.xlsx("F:/OneDrive/MPF/Fidelity/202001/S.xlsx")
...
MPF.Fidelity.S <-
  as.xts(read.zoo(MPF.Fidelity.S, format = "%Y-%m-%d"))

MPF.Fidelity.MPFC <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/MPFC.xlsx")
MPF.Fidelity.MPFC[, 1] <- convertToDate(MPF.Fidelity.MPFC[, 1])
MPF.Fidelity.MPFC <-
  MPF.Fidelity.MPFC[11:length(MPF.Fidelity.MPFC[, 1]), ]
rownames(MPF.Fidelity.MPFC) <- MPF.Fidelity.MPFC[, 1]
colnames(MPF.Fidelity.MPFC) <- c("Date", "HKD")
MPF.Fidelity.MPFC <-
  as.xts(read.zoo(MPF.Fidelity.MPFC, format = "%Y-%m-%d"))

MPF.Fidelity.GE <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/GE.xlsx")
...
MPF.Fidelity.GE <-
  as.xts(read.zoo(MPF.Fidelity.GE, format = "%Y-%m-%d"))

MPF.Fidelity.G <- read.xlsx("F:/OneDrive/MPF/Fidelity/202001/G.xlsx")
...
MPF.Fidelity.G <-
  as.xts(read.zoo(MPF.Fidelity.G, format = "%Y-%m-%d"))

MPF.Fidelity.HKB <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/HKB.xlsx")
MPF.Fidelity.HKB[, 1] <- convertToDate(MPF.Fidelity.HKB[, 1])
MPF.Fidelity.HKB <-
  MPF.Fidelity.HKB[11:length(MPF.Fidelity.HKB[, 1]), ]
rownames(MPF.Fidelity.HKB) <- MPF.Fidelity.HKB[, 1]
colnames(MPF.Fidelity.HKB) <- c("Date", "HKD")
MPF.Fidelity.HKB <-
  as.xts(read.zoo(MPF.Fidelity.HKB, format = "%Y-%m-%d"))

MPF.Fidelity.HKE <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/HKE.xlsx")
MPF.Fidelity.HKE[, 1] <- convertToDate(MPF.Fidelity.HKE[, 1])
MPF.Fidelity.HKE <-
  MPF.Fidelity.HKE[11:length(MPF.Fidelity.HKE[, 1]), ]
rownames(MPF.Fidelity.HKE) <- MPF.Fidelity.HKE[, 1]
colnames(MPF.Fidelity.HKE) <- c("Date", "HKD")
MPF.Fidelity.HKE <-
  as.xts(read.zoo(MPF.Fidelity.HKE, format = "%Y-%m-%d"))

MPF.Fidelity.RMBB <-
  na.omit(read.xlsx("F:/OneDrive/MPF/Fidelity/202001/RMBB.xlsx"))
MPF.Fidelity.RMBB[, 1] <- convertToDate(MPF.Fidelity.RMBB[, 1])
MPF.Fidelity.RMBB <-
  MPF.Fidelity.RMBB[11:length(MPF.Fidelity.RMBB[, 1]), ]
rownames(MPF.Fidelity.RMBB) <- MPF.Fidelity.RMBB[, 1]
colnames(MPF.Fidelity.RMBB) <- c("Date", "HKD")
MPF.Fidelity.RMBB <-
  as.xts(read.zoo(MPF.Fidelity.RMBB, format = "%Y-%m-%d"))

MPF.Fidelity.SG <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/SG.xlsx")
...
MPF.Fidelity.SG <-
  as.xts(read.zoo(MPF.Fidelity.SG, format = "%Y-%m-%d"))

MPF.Fidelity.HSI <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/HSI.xlsx")
MPF.Fidelity.HSI[, 1] <- convertToDate(MPF.Fidelity.HSI[, 1])
MPF.Fidelity.HSI <-
  MPF.Fidelity.HSI[11:length(MPF.Fidelity.HSI[, 1]), ]
rownames(MPF.Fidelity.HSI) <- MPF.Fidelity.HSI[, 1]
colnames(MPF.Fidelity.HSI) <- c("Date", "HKD")
MPF.Fidelity.HSI <-
  as.xts(read.zoo(MPF.Fidelity.HSI, format = "%Y-%m-%d"))

MPF.Fidelity.GB <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/GB.xlsx")
...
MPF.Fidelity.GB <-
  as.xts(read.zoo(MPF.Fidelity.GB, format = "%Y-%m-%d"))

MPF.Fidelity.Save2040 <-
  read.xlsx("F:/OneDrive/MPF/Fidelity/202001/Save2040.xlsx")
MPF.Fidelity.Save2040[, 1] <-
  convertToDate(MPF.Fidelity.Save2040[, 1])
MPF.Fidelity.Save2040 <-
  MPF.Fidelity.Save2040[11:length(MPF.Fidelity.Save2040[, 1]), ]
rownames(MPF.Fidelity.Save2040) <- MPF.Fidelity.Save2040[, 1]
colnames(MPF.Fidelity.Save2040) <- c("Date", "HKD")
MPF.Fidelity.Save2040 <-
  as.xts(read.zoo(MPF.Fidelity.Save2040, format = "%Y-%m-%d"))
...
MPF.Fidelity <-
  as.xts(sapply(MPF.Fidelity, as.numeric), order.by = daily)
...
```{r warning=FALSE}
MPF.Fidelity.SMA.hy <-
  na.fill(apply(MPF.Fidelity, 2, function(x)
...
MPF.Fidelity.Save2040 <-
  monthlyReturn(MPF.Fidelity[, 15], type = "log")
...
MPF.Fidelity.SFP <-
  monthlyReturn(MPF.Fidelity[, 1], type = "arithmetic")
MPF.Fidelity.CA <-
  monthlyReturn(MPF.Fidelity[, 2], type = "arithmetic")
MPF.Fidelity.AP <-
  monthlyReturn(MPF.Fidelity[, 3], type = "arithmetic")
MPF.Fidelity.B <- monthlyReturn(MPF.Fidelity[, 4], type = "arithmetic")
MPF.Fidelity.S <- monthlyReturn(MPF.Fidelity[, 5], type = "arithmetic")
MPF.Fidelity.MPFC <-
  monthlyReturn(MPF.Fidelity[, 6], type = "arithmetic")
MPF.Fidelity.GE <-
  monthlyReturn(MPF.Fidelity[, 7], type = "arithmetic")
MPF.Fidelity.G <- monthlyReturn(MPF.Fidelity[, 8], type = "arithmetic")
MPF.Fidelity.HKB <-
  monthlyReturn(MPF.Fidelity[, 9], type = "arithmetic")
MPF.Fidelity.HKE <-
  monthlyReturn(MPF.Fidelity[, 10], type = "arithmetic")
MPF.Fidelity.RMBB <-
  monthlyReturn(MPF.Fidelity[, 11], type = "arithmetic")
MPF.Fidelity.SG <-
  monthlyReturn(MPF.Fidelity[, 12], type = "arithmetic")
MPF.Fidelity.HSI <-
  monthlyReturn(MPF.Fidelity[, 13], type = "arithmetic")
MPF.Fidelity.GB <-
  monthlyReturn(MPF.Fidelity[, 14], type = "arithmetic")
MPF.Fidelity.Save2040 <-
  monthlyReturn(MPF.Fidelity[, 15], type = "arithmetic")
...
colnames(MPF.Fidelity.simple.returns) <-
  c(
    'SFP',
    'CA',
    'AP',
...
```{r warning=FALSE}
MPF.Fidelity.RSI.month <-
  as.xts(do.call(rbind, lapply(split(as.xts(MPF.Fidelity.RSI), "months"), function(x)
...
for (col in 1:length(MPF.Fidelity.RSI.month[1, ])) {
  if (col != 6) {
    for (row in 1:length(MPF.Fidelity.RSI.month[, col])) {
      ...
      if (percentile(MPF.Fidelity.RSI.month[row, col]) >= (RSI_Overbuy - 1 /
                                                           length(1:row) ^ (1 / 2))) {
        MPF.Fidelity.RSI.p[row, col] <- 0.2
      } else {
        MPF.Fidelity.RSI.p[row, col] <-
          1.2 - (percentile(MPF.Fidelity.RSI.month[row, col]) ^ (3))
      }
    }
  } else {
...
MPF.Fidelity.RSI.sum <-
  as.xts(rowSums(MPF.Fidelity.RSI.p), order.by = monthly)

for (row in 1:length(MPF.Fidelity.RSI.p[, col])) {
  MPF.Fidelity.RSI.p[row, ] <-
    apply(MPF.Fidelity.RSI.p[row, ], 2, function(x)
      (x / MPF.Fidelity.RSI.sum[row, 1]) ^ (1 / 4))
}
MPF.Fidelity.RSI.sum <-
  as.xts(rowSums(MPF.Fidelity.RSI.p), order.by = monthly) 
...
```{r warning=FALSE}
rm(
  MPF.Fidelity.BIAS.diff,
  MPF.Fidelity.BIAS.diff.qu,
  MPF.Fidelity.BIAS.month,
  MPF.Fidelity.BIAS.p
)
MPF.Fidelity.BIAS.diff <-
  (MPF.Fidelity.SMA.mt - MPF.Fidelity.SMA.hy) / MPF.Fidelity.SMA.hy
MPF.Fidelity.BIAS.diff.qu <-
  MPF.Fidelity.BIAS.diff - stats::lag(MPF.Fidelity.BIAS.diff, k = 21 * nm)
MPF.Fidelity.BIAS.diff.qu <- na.fill(MPF.Fidelity.BIAS.diff.qu, 0)


MPF.Fidelity.BIAS.month <-
  do.call(rbind, lapply(split(
    as.xts(MPF.Fidelity.BIAS.diff.qu), "months"
  ), function(x)
    colAvgs(x)))
...
MPF.Fidelity.stock.return <-
  as.xts(rowSums(MPF.Fidelity.BIAS.month), order.by = monthly)
...
for (row in 1:length(MPF.Fidelity.BIAS.month[, 1])) {
  MPF.Fidelity.BIAS.month[row, ] <-
    (MPF.Fidelity.BIAS.month[row, ]) * MPF.Fidelity.RSI.p[row, ]
  MPF.Fidelity.stock.mean <- 0
  i <- 0
  for (col in 1:length(MPF.Fidelity.BIAS.month[1, ])) {
    if (col != 1 &&
        col != 5 &&
        col != 6 && col != 9 && col != 11 && col != 12 && col != 14) {
      if (!is.na(MPF.Fidelity.returns.mat[row, col]) &&
          MPF.Fidelity.returns.mat[row, col] != 0) {
        MPF.Fidelity.stock.mean <-
          MPF.Fidelity.stock.mean + MPF.Fidelity.returns.mat[row, col]
        i <- i + 1
      }
  ...
  if (row > 8 &&  (
    MPF.Fidelity.stock.return[row] < 0 &&
  ...
  if (row <= 12 ||
      MPF.Fidelity.sum == MPF.Fidelity.BIAS.month[row, 6] ||
      MPF.Fidelity.sum < 1e-6 || hedge == TRUE) {
    if (row >= 198) {
      MPF.Fidelity.BIAS.p[1] <- 0.4
      MPF.Fidelity.BIAS.p[6] <- 0.3
      MPF.Fidelity.BIAS.p[14] <- 0.3
    } else if (row >= 34) {
      MPF.Fidelity.BIAS.p[6] <- 0.5
      MPF.Fidelity.BIAS.p[14] <- 0.5
    } else {
    ...
    if (row >= 198) {
      MPF.Fidelity.BIAS.p[] <-
        MPF.Fidelity.BIAS.month[row,] / MPF.Fidelity.sum / 10 * 7
      MPF.Fidelity.BIAS.p[14] <- MPF.Fidelity.BIAS.p[14] + 0.1
      MPF.Fidelity.BIAS.p[6] <- MPF.Fidelity.BIAS.p[6] + 0.08
      MPF.Fidelity.BIAS.p[1] <- MPF.Fidelity.BIAS.p[1] + 0.12
    } else if (row >= 34) {
      MPF.Fidelity.BIAS.p[] <-
        MPF.Fidelity.BIAS.month[row,] / MPF.Fidelity.sum / 10 * 7
      MPF.Fidelity.BIAS.p[14] <- MPF.Fidelity.BIAS.p[14] + 0.18
      MPF.Fidelity.BIAS.p[6] <- MPF.Fidelity.BIAS.p[6] + 0.12
    } else {
      MPF.Fidelity.BIAS.p[] <-
        MPF.Fidelity.BIAS.month[row,] / MPF.Fidelity.sum / 10 * 7
    ...
    MPF.Fidelity.BIAS.p[] <-
      MPF.Fidelity.BIAS.month[row,] / MPF.Fidelity.sum
  }
...
portf.rebal.fm.dollar.gb <- Return.portfolio(
  tail(MPF.Fidelity.simple.returns,-48),
...
ggplot() +
  scale_color_manual(
    labels = c("SPY", "QQQ", "HSI", "TORI @ Fidelity"),
  ...
  geom_line(aes(x = date, y = Ra, color = "pink3"), portf.dollar.monthly, 
            size =1.8) +
  labs(
    title = "TORI @ Fidelity versus SPY, QQQ, and Hang Seng Index",
    subtitle = "How TORI @ Fidelity outperform common index fund",
    x = "",
    y = "Portfolio Value",
...
ggplot() +
  scale_color_manual(labels = c("Golden Butterfly", "TORI @ Fidelity"),
                     values = c(4, "pink3")) +
  ...
  geom_line(aes(x = date, y = Ra, color = "pink3"),
            ...
            size = 1.8) +
  labs(
    title = "TORI @ Fidelity versus Golden Butterfly Portfolio",
    subtitle = "How TORI @ Fidelity outperform golden butterfly portfolio",
    x = "",
    y = "Portfolio Value",
    color = "Portfolio"
  ) +
