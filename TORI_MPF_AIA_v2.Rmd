...
```{r linewidth=40,  warning=FALSE, results=FALSE}
library("zoo")
library("xts")
...
MPF.AIA.MPFC <- monthlyReturn(as.xts(MPF.AIA$MPFC), type="arithmetic")
...
MPF.AIA.simple.returns <- merge(MPF.AIA.AB, MPF.AIA.AE, MPF.AIA.B, MPF.AIA.CA, MPF.AIA.EAT,
                         MPF.AIA.EE, MPF.AIA.FB, MPF.AIA.FG, MPF.AIA.FS, MPF.AIA.G,
                         MPF.AIA.GB, MPF.AIA.GCE, MPF.AIA.GCP, MPF.AIA.GCT, MPF.AIA.GF,
                         MPF.AIA.GT, MPF.AIA.HKE, MPF.AIA.JE, MPF.AIA.MPFC, MPF.AIA.NAE,
                         MPF.AIA.NAT, MPF.AIA.P, MPF.AIA.S, MPF.AIA.SFP)

colnames(MPF.AIA.simple.returns) <- c("AB", "AE", "B", "CA", "EAT",
                         "EE", "FB", "FG", "FS", "G",
                         "GB", "GCE", "GCP", "GCT", "GF",
                         "GT", "HKE", "JE", "MPFC", "NAE",
                         "NAT", "P", "S", "SFP")
...
MPF.AIA.BIAS.diff.qu <- MPF.AIA.BIAS.diff - stats::lag(MPF.AIA.BIAS.diff, k=21*nm)
...
ggplot()+
  scale_color_manual(labels = c("SPY", "QQQ", "HSI", "TORI @ AIA"), 
  ...
  labs(title = "TORI @ AIA versus SPY, QQQ, and Hang Seng Index",
...
ggplot()+
  ...
  labs(title = "TORI @ AIA versus Golden Butterfly Portfolio",
