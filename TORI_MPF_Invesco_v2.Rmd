...
年率化回報 Annualized Return: ~9.77%     
算術年均回報 Mean Annual Return: ~9.80%       
累積回報（等比） Cumulative Return (Geometric): ~487.89%    
年率化標準誤差 Annualized Standard Deviation: ~9.55%     
夏普比率 Sharpe Ratio: 1.0236          
索丁諾比率 Sortino Ratio: 2.1254 (MAR = 0%)      
資訊比率 Information Ratio: 0.2027 (SPY), 0.384 (HSI), 0.2115 (Golden Butterfly)    
Jensen's Alpha: 0.0811 (SPY), 0.0857 (HSI), 0.1115 (Golden Butterfly)    
Beta: 0.2587 (SPY), 0.2831 (HSI), -0.0312 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.3821 (SPY), 0.6040 (HSI), -0.0229 (Golden Butterfly)    
預期損失 Expected Shortfall: 2.50 % loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 1505745        
算術年均回報 Mean annual return: 9.31%      
內部回報率 Internal Rate of Return (IRR): 9.55%    
年率化標準誤差 Annualized Standard Deviation: 9.53%    
夏普比率 Sharpe Ratio: 0.9774          
索丁諾比率 Sortino Ratio: 2.1207 (MAR = 0%)    
...
for (row in 1:length(MPF.Invesco.BIAS.month[, 1])) {
  MPF.Invesco.BIAS.month[row, ] <-
    (MPF.Invesco.BIAS.month[row, ]) * MPF.Invesco.RSI.p[row, ]#* VIX.month[row,6] * (MPF.Invesco.RSI.p[row,])
...
portf.rebal.fm.dollar.gb <- Return.portfolio(
  tail(MPF.Invesco.simple.returns,-48),
