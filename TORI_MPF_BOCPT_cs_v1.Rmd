...
年率化回報 Annualized Return: ~9.32%     
算術年均回報 Mean Annual Return: ~9.40%       
累積回報（等比） Cumulative Return (Geometric): ~443.72%    
年率化標準誤差 Annualized Standard Deviation: ~9.68% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 9.32%/9.68% = 0.9631          
索丁諾比率 Sortino Ratio: 0.5501 (MAR = 0%)      
預期損失 Expected Shortfall: 5.48% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 991844.4        
算術年均回報 Mean annual return: 8.57%      
內部回報率 Internal Rate of Return (IRR): 9.64%    
年率化標準誤差 Annualized Standard Deviation: 9.65%    
夏普比率 Sharpe Ratio: 0.8886          
索丁諾比率 Sortino Ratio: 0.5138 (MAR = 0%)    
