...
年率化回報 Annualized Return: ~8.73%     
算術年均回報 Mean Annual Return: ~8.85%       
累積回報（等比） Cumulative Return (Geometric): ~390.10%    
年率化標準誤差 Annualized Standard Deviation: ~9.66% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 8.73%/9.66% = 0.9032          
索丁諾比率 Sortino Ratio: 0.5098 (MAR = 0%)      
預期損失 Expected Shortfall: 5.56% loss (0% Risk-free rate, 95% C.I.)       
