...
## NEWS 最新消息    
### -5.48% loss against -5.73% loss had been recorded by Tori @ HSBC against Golden butterfly portfolio from 2020/01/01 to 2020/03/25. Monthly contribution of Akane Tori @ HSBC is -4.86% at the same period. SPY and HSI had crashed and in turmoil already. Prelim result:      
### Akane Tori @ HSBC於2020/01/01至2020/03/25的首筆供款表現為-5.48%，同期Golden Butterfly的首筆供款表現為-5.73%。同期Akane Tori @ HSBC      的月供表現為-4.86%。SPY及恒生指數大跌而陷入調整／熊市。初步數據如下表所示：     
...
年率化回報 Annualized Return: ~12.18%     
算術年均回報 Mean Annual Return: ~12.15%       
累積回報 Cumulative Return: ~788.68%    
年率化標準誤差 Annualized Standard Deviation: ~11.17% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.1453          
索丁諾比率 Sortino Ratio: 2.2449 (MAR = 0%)      
資訊比率 Information Ratio: 0.3938 (SPY), 0.5390(HSI), 0.3956 (Golden Butterfly)     
Jensen's Alpha: 0.0961 (SPY), 0.1085 (HSI), 0.1410 (Golden Butterfly)    
Beta: 0.3777 (SPY), 0.3319 (HSI), -0.0469 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.4860 (SPY), 0.6049 (HSI), -0.0311 (Golden Butterfly)    
預期損失 Expected Shortfall: 5.72% loss (0% Risk-free rate, 95% C.I.)       
...
最新結餘 Latest asset value: 2157960    
算術年均回報 Mean annual return (arithmetric): 11.73%      
內部回報率 Internal Rate of Return (IRR): 12.38%    
年率化標準誤差 Annualized Standard Deviation: 11.15%    
夏普比率 Sharpe Ratio: 1.0521          
索丁諾比率 Sortino Ratio: 2.2429 (MAR = 0%)    
...
MPF.HSBC <-
  as.xts(
    read.zoo(
      "F:/OneDrive/MPF/HSBC SuperTrust Plus/HSBC_MPF_SuperTrustPlus.csv",
      format = "%d/%m/%Y",
      header = TRUE,
      na.strings = "0",
      read = read.csv
...
portf.rebal.fm.dollar.gb <- Return.portfolio(
  tail(MPF.HSBC.simple.returns,-48),
