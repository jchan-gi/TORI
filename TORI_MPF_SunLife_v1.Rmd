...
年率化回報 Annualized Return: ~9.52%     
算術年均回報 Mean Annual Return: ~9.16%       
累積回報（等比） Cumulative Return (Geometric): ~425.73%    
年率化標準誤差 Annualized Standard Deviation: ~8.57% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 9.52%/8.57% = 1.1110          
索丁諾比率 Sortino Ratio: 0.7822 (MAR = 0%)      
預期損失 Expected Shortfall: 4.02 % loss (0% Risk-free rate, 95% C.I.)       
...
算術年均回報 Mean annual return: 9.70%      
內部回報率 Internal Rate of Return (IRR): 9.58%    
年率化標準誤差 Annualized Standard Deviation: 8.60%    
夏普比率 Sharpe Ratio: 1.1278          
索丁諾比率 Sortino Ratio: 0.7957 (MAR = 0%)    
