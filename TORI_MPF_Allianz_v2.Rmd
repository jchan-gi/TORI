...
年率化回報 Annualized Return: ~11.39%     
算術年均回報 Mean Annual Return: ~11.13%       
累積回報 Cumulative Return: ~649.37%    
年率化標準誤差 Annualized Standard Deviation: ~10.18% (StdDev(monthly return) * sqrt(12))    
夏普比率 Sharpe Ratio: 1.1189          
索丁諾比率 Sortino Ratio: 2.7182 (MAR = 0%)    
資訊比率 Information Ratio: 0.2797 (SPY), 0.3726 (HSI), 0.2897 (Golden Butterfly)    
Jensen's Alpha: 0.0923 (SPY), 0.1182 (HSI), 0.1213 (Golden Butterfly)    
Beta: 0.0155 (SPY), 0.0153 (HSI), 0.0028 (Golden Butterfly)     
關聯系數 Correlation Coefficient: 0.0220 (SPY), 0.0308 (HSI), 0.0019 (Golden Butterfly)    
...
最新結餘 Latest asset value: 1637231        
算術年均回報 Mean annual return: 11.18%      
內部回報率 Internal Rate of Return (IRR): 10.55%    
年率化標準誤差 Annualized Standard Deviation: 10.16%    
夏普比率 Sharpe Ratio: 1.1006          
索丁諾比率 Sortino Ratio: 2.7213 (MAR = 0%)    
...
MPF.Allianz.AE <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/AE.xlsx")
...
MPF.Allianz.B <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/B.xlsx")
...
MPF.Allianz.CA <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/CA.xlsx")
...
MPF.Allianz.FlexB <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/FlexB.xlsx")
...
MPF.Allianz.G <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/G.xlsx")
...
MPF.Allianz.GCE <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/GCE.xlsx")
...
MPF.Allianz.HKE <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/HKE.xlsx")
...
MPF.Allianz.MPFC <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/MPFC.xlsx")
...
MPF.Allianz.Pacific <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/Pacific.xlsx")
...
MPF.Allianz.RMB <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/RMB.xlsx")
...
MPF.Allianz.S <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/S.xlsx")
...
MPF.Allianz.SFP <-
  read.xlsx("F:/OneDrive/MPF/Allianz/202001/SFP.xlsx")
...
MPF.Allianz.SG <- read.xlsx("F:/OneDrive/MPF/Allianz/202001/SG.xlsx")
...
portf.rebal.fm.dollar.gb <- Return.portfolio(
  tail(MPF.Allianz.simple.returns,-44),
  weight = tail(MPF.portf.weight,-44),
  geometric = TRUE,
  rebalance_on = "months"
)
...
for (row in 1:length(MPF.Allianz.simple.returns[, 1])) {
  ...
  if (row == 1) {
    ...
    this.unit <-
      as.matrix(this.unit) + (2301 / as.matrix(this.price) *
                                MPF.portf.weight[row, ])
